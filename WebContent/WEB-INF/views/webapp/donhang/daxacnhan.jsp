...
<body>
    ...
    <div class="wishlist-box-main">
        <div class="container">
         <a href="../donhang2/index.htm"><button type="button" class="btn btn-secondary">Chờ xác nhận</button></a>
        <a href="../donhang2/daxacnhan.htm"><button type="button" class="btn btn-success">Đã xác nhận</button></a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <c:if test="${pagedListHolder.pageList.size() == 0 or pagedListHolder.pageList.size() == null}">
                    	<h2>Không có đơn hàng nào đã xác nhận!</h2>
                    </c:if>
                    <c:if test="${pagedListHolder.pageList.size() != 0 and pagedListHolder.pageList.size() != null}">
							...
							<td>${gh.ngayDat}</td>
							<td>
								<a href="../donhang2/${gh.maGH}.htm?linkChiTiet2">
