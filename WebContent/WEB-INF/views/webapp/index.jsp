...
<body>
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item active"><a class="nav-link" href="../webapp/index.htm">Trang chủ</a></li>
    ...
    <!-- End Top Search -->
    <!-- Start Slider -->
    <div id="slides-shop" style="height: 400px;" class="cover-slides">
        <ul class="slides-container">
            <li class="text-center">
                <img src="../resources/khachhang/assets/images/banner_01.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 50px;"><strong> Chào mừng đến với <br> Cửa hàng thuỷ sinh vật cảnh</strong></p>
                            <p class="m-b-40">Mời tham quan shop <br> Ở đây có nhiều loại cá cảnh!</p>
                        </div>
                    </div >
                </div>
            </li>
            <li class="text-center">
                <img src="../resources/khachhang/assets/images/banner_02.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 50px;"><strong> Chào mừng đến với <br> Cửa hàng thuỷ sinh vật cảnh</strong></p>
                            <p class="m-b-40">Và cả những loại cây cảnh trong bể cá!</p>
                        </div>
                    </div>
                </div>
            </li>
            <li class="text-center">
                <img src="../resources/khachhang/assets/images/banner_03.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 50px;"><strong> Chào mừng đến với <br> Cửa hàng thuỷ sinh vật cảnh</strong></p>
            ...
            <li class="text-center">
                <img src="../resources/khachhang/assets/images/banner_04.jpg" alt="">
                <div class="container">
                    <div class="row">
                       <div class="col-md-12">
                            <p style="font-size: 50px;"><strong> Chào mừng đến với <br> Cửa hàng thuỷ sinh vật cảnh</strong></p>
                    ...
                    <c:forEach var="spbc" items="${dSSPBC }">
                    	<div class="item">
                            <div class="products-single fix">
                                <div class="box-img-hover" style="width: 360px; height: 150px;">
