...
<div class="main-wrapper">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-2">
			 	<a type="button" class="btn btn-success" href="../sinhvatcanh/them.htm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3v-3z"/>
</svg>&nbsp;Thêm mới</a>
			</div>
		<jsp:useBean id="pagedListHolder" scope="request"
				type="org.springframework.beans.support.PagedListHolder" />
			<c:url value="../sinhvatcanh/index.htm" var="pagedLink">
			...
			<table class="table table-striped">
				...
				<tbody>
					<%-- <c:forEach var="svc" items="${dSSinhVatCanh}"> --%>
					<c:forEach var="svc" items="${pagedListHolder.pageList}">
						<tr >
							...
							<td class="text-center">${svc.maTT.tenTT}</td>
							<td class="text-center">
								<a href="../sinhvatcanh/${svc.maSVC}.htm?linkInfor">
  ...
  <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
							...
							<td class="text-center">
								<a href="../hinhanh/${svc.maSVC}.htm?linkPic">
