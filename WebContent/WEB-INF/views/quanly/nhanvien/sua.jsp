...
<div class="main-wrapper">
	...
	<main class="main users chart-page" id="skip-target">
		<div class="container">
			<h2 class="main-title text-primary" >Chỉnh sửa nhân viên</h2>
			<div class="p-3 mb-2 bg-light text-dark">
				<form:form modelAttribute="nhanVien" action="../nhanvien/sua.htm">
					<div class = "row">
						<div class="col-md-3">
    						<label class="form-label"><b>Mã nhân viên</b></label><label style="color: red;">&nbsp *</label>
    						<form:input path="maNV" class="form-control" disabled="true"/>
