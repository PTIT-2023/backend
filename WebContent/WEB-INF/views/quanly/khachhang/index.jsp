...
<div class="main-wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h2 class="main-title text-primary" >Danh sách khách hàng</h2>
			</div>
			</div>
				...
				<tbody>
					<c:forEach var="kh" items="${pagedListHolder.pageList}">
						<tr >
							...
							<td class="text-center">${kh.ho}</td>
							<td class="text-center">${kh.ten}</td>
							<td class="text-center">${kh.gioiTinh}</td>
							<td class="text-center">${kh.maSoThue}</td>
							<td class="text-center">${kh.sDT}</td>
							<td class="text-center">
								<a href="../khachhang/${kh.maKH}.htm?linkEdit">
